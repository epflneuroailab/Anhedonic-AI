...
def load_activation_mean(filename):
    ...
    if not os.path.exists(found_path):
        raise FileNotFoundError(
            ...
            f"Make sure extract_activations_llama.py has been run and files are in {ACTIVATIONS_DIR}/"
        )
...
def main():
    print("=" * 60)
    print("EXTRACTING UNIVERSAL MLP NEURONS — Llama-3.1-8B-Instruct")
    print("(3-Sigma Cross-Domain)")
    print("=" * 60)
    ...
    print(f"  (Expected: 32 layers x 14336 neurons for Llama-3.1-8B)")
